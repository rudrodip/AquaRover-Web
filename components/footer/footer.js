...
// importing necessary dependenciess
						...
						<Link legacyBehavior href='/'>
							<a className="flex title-font font-medium items-center text-white mb-0 lg:mb-4 md:mb-0">
								<Image
									...
									height={50}
								/>
								<span className="ml-3 text-xl">AquaRover</span>
							</a>
						</Link>
						<p className="mt-2 text-sm text-gray-500">AquaRover - Clean and Safe water for everyone</p>
					</div>
